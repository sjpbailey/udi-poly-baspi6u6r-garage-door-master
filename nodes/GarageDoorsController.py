...
class GarageDoorsController(Controller):
    ...
    def start(self):
        ...
        LOGGER.info('Started BAS Garage Doors NodeServer {}'.format(serverdata['version']))
    ...
    def discover(self, *args, **kwargs):
        ...
        if self.ipaddress is not None:
            ...
            self.addNode(GarageDoorsNodes(self, self.address, 'baspidoor1_id', 'Doors 1-6', self.ipaddress, self.bc))
    ...
    def check_params(self):
        ...
        self.addCustomParam({'door_ip': self.ipaddress})
